		...
		$settings['advanced'] = array(
			...
			'fields'				=> array(
				...
				array(
					...
					'label'			=> __( 'Content Before Table' , $this->textdomain ),
				...
				array(
					...
					'label'			=> __( 'Content After Table' , $this->textdomain ),
					'description'	=> __( 'Text area for content.', $this->textdomain ),
					'type'			=> 'textarea',
					'default'		=> '',
					'placeholder'	=> __( 'HTML and text', $this->textdomain )
	...
	public function display_field( $args ) {
		...
		switch( $field['type'] ) {
			...
			case 'instructions':
				...
				<h5 style="color:red">' . __( 'Due to User information which displays in this plugin TABLE VIEW or "list view" MAY NOT BE USE ON HOME PAGES','profile-details-tsw') . '</h5>
...
<p>'. esc_html__( '3. Go through settings and add field names and page view preferrences.', 'profile-details-tsw') .'</p></div>';
	...
	?>
	  <div class="wrap" id="<?php echo $this->plugin_slug; ?>">
	  	<h2><?php _e('Profile Details TSW Plugin Settings', $this->textdomain); ?></h2>
